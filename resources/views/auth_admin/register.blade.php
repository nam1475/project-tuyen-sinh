                ...
                <div class="p-5">
                  ...
                  <form action="{{ route('register.save') }}" method="POST" class="user">
                    ...
                    <div class="form-group">
                      ...
                      @error('name')
                        <span class="invalid-feedback">Vui lòng nhập tên</span>
                      @enderror
                    </div>
                    <div class="form-group">
                      ...
                      @error('email')
                        <span class="invalid-feedback"> Vui lòng nhập email</span>
                      @enderror
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        ...
                        @error('password_confirmation')
                          <span class="invalid-feedback"> Vui lòng nhập lại mật khẩu</span>
                        @enderror
                      </div>
                    </div>
